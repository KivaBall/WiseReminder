...
public sealed class QuotesControllerPostMethodsTests : BaseControllerTests
{
    ...
    {
        //Arrange
        var request = QuoteData.CreateQuoteByAdminRequest(AdminIds.AuthorId, AdminIds.CategoryId);
    ...
    {
        //Arrange
        var request = QuoteData.CreateQuoteByAdminRequest(Guid.NewGuid(), Guid.NewGuid());
    ...
    {
        //Arrange
        var request = QuoteData.CreateQuoteByAdminRequest(UserIds.AuthorId, AdminIds.CategoryId);
    ...
    {
        //Arrange
        var request = QuoteData.CreateQuoteByAdminRequest(Guid.NewGuid(), AdminIds.CategoryId);
    ...
    {
        //Arrange
        var request = QuoteData.CreateQuoteByAdminRequest(AdminIds.AuthorId, Guid.NewGuid());
